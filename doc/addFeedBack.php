            ...
            echo"<form>
              ...
              <div class='row'>
                <div class='col-xl-12 col-sm-6'>
                  <div class='form-group mb-3'>
                    <label>Enter descriptive feedback on patient with code ".$_GET['patId']."</label>
                    <textarea name='pat_code' class='form-control' placeholder='Enter feedback' required=''></textarea>
                  </div>
                </div>
              </div>

              <button type='submit' name='editPatientInfo' class='btn btn-primary'>Save Changes</button>
            </form>";
          ?>
