        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          ...
          <form method="POST" action="../server.php">
            <div class="form-group mb-3">
              ...
              <input type="text" name="fullname" class="form-control" placeholder="Enter user full name" required="">
            </div>
             <div class="form-group mb-3">
              <label>User phone number</label>
              <input type="text" name="phonenumber" maxlength="10" minlength="10" class="form-control" placeholder="Enter user phone number" required="">
            </div>
            <div class="form-group mb-3">
